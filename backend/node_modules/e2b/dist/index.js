...
var Filesystem2 = class {
  ...
  async watchDir(path2, onEvent, opts) {
    ...
    if ((opts == null ? void 0 : opts.allowNetworkMounts) && this.envdApi.version && (0, import_compare_versions2.compareVersions)(this.envdApi.version, ENVD_VERSION_WATCH_NETWORK_MOUNTS) < 0) {
      throw new TemplateError(
